...
public class PduHeaders
{
  ...
  protected void appendEncodedStringValue(EncodedStringValue paramEncodedStringValue, int paramInt)
  {
    if (paramEncodedStringValue != null)
    {
      ...
      ArrayList localArrayList1 = (ArrayList)mHeaderMap.get(Integer.valueOf(paramInt));
      ArrayList localArrayList2 = localArrayList1;
      if (localArrayList1 == null) {
        localArrayList2 = new ArrayList();
      }
      localArrayList2.add(paramEncodedStringValue);
      mHeaderMap.put(Integer.valueOf(paramInt), localArrayList2);
      return;
    }
  ...
  protected void setEncodedStringValue(EncodedStringValue paramEncodedStringValue, int paramInt)
  {
    if (paramEncodedStringValue != null)
    {
      if ((paramInt != 137) && (paramInt != 147) && (paramInt != 150) && (paramInt != 154) && (paramInt != 160) && (paramInt != 164) && (paramInt != 166)) {
        switch (paramInt)
        {
        default: 
          throw new RuntimeException("Invalid header field!");
  ...
  {
    if ((paramInt != 133) && (paramInt != 142) && (paramInt != 157) && (paramInt != 159) && (paramInt != 161) && (paramInt != 173) && (paramInt != 175) && (paramInt != 179)) {
      switch (paramInt)
      {
      default: 
        throw new RuntimeException("Invalid header field!");
    ...
    throws InvalidHeaderValueException
  {
    ...
    case 141: 
      ...
      break;
    case 140: 
      if ((paramInt1 >= 128) && (paramInt1 <= 151)) {
        i = paramInt1;
      } else {
        throw new InvalidHeaderValueException("Invalid Octet value!");
      }
