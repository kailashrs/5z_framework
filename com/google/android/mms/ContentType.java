...
public class ContentType
{
  ...
  {
    boolean bool;
    if ((isAudioType(paramString)) && (isSupportedType(paramString))) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  {
    boolean bool;
    if ((isImageType(paramString)) && (isSupportedType(paramString))) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  {
    boolean bool;
    if ((paramString != null) && (sSupportedContentTypes.contains(paramString))) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  {
    boolean bool;
    if ((isVideoType(paramString)) && (isSupportedType(paramString))) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  {
    boolean bool;
    if ((paramString != null) && (paramString.startsWith("text/"))) {
      bool = true;
    } else {
      bool = false;
    }
