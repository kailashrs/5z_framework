...
public abstract interface SystemMessageProto
{
    ...
    extends MessageNano
  {
    ...
    public static SystemMessage parseFrom(CodedInputByteBufferNano paramCodedInputByteBufferNano)
      throws IOException
    {
      return new SystemMessage().mergeFrom(paramCodedInputByteBufferNano);
    }
    
    public static SystemMessage parseFrom(byte[] paramArrayOfByte)
      throws InvalidProtocolBufferNanoException
    {
      return (SystemMessage)MessageNano.mergeFrom(new SystemMessage(), paramArrayOfByte);
    }
    ...
    public SystemMessage mergeFrom(CodedInputByteBufferNano paramCodedInputByteBufferNano)
      throws IOException
    {
      for (;;)
      {
