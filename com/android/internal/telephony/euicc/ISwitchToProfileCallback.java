...
public abstract interface ISwitchToProfileCallback
  extends IInterface
{
    ...
    implements ISwitchToProfileCallback
  {
    ...
    public static ISwitchToProfileCallback asInterface(IBinder paramIBinder)
    {
      if (paramIBinder == null) {
        return null;
      }
      IInterface localIInterface = paramIBinder.queryLocalInterface("com.android.internal.telephony.euicc.ISwitchToProfileCallback");
      if ((localIInterface != null) && ((localIInterface instanceof ISwitchToProfileCallback))) {
        return (ISwitchToProfileCallback)localIInterface;
      }
      ...
      throws RemoteException
    {
      if (paramInt1 != 1)
      {
        ...
        paramParcel2.writeString("com.android.internal.telephony.euicc.ISwitchToProfileCallback");
        return true;
      }
      paramParcel1.enforceInterface("com.android.internal.telephony.euicc.ISwitchToProfileCallback");
      ...
      implements ISwitchToProfileCallback
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel.writeInterfaceToken("com.android.internal.telephony.euicc.ISwitchToProfileCallback");
