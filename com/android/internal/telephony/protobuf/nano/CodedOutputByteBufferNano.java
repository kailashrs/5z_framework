    ...
    throws IOException
  {
    try
    {
      ...
      if (i == computeRawVarint32Size(paramString.length() * 3))
      {
        ...
        {
          paramString = new com/android/internal/telephony/protobuf/nano/CodedOutputByteBufferNano$OutOfSpaceException;
    ...
    {
      paramString = new OutOfSpaceException(buffer.position(), buffer.limit());
