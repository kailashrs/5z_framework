...
public class Extension<M extends ExtendableMessageNano<M>, T>
{
  ...
  protected Object readData(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    ...
    try
    {
      ...
      {
      default: 
        paramCodedInputByteBufferNano = new java/lang/IllegalArgumentException;
        break;
      case 11: 
      ...
      paramCodedInputByteBufferNano.<init>(((StringBuilder)localObject).toString());
      throw paramCodedInputByteBufferNano;
    }
