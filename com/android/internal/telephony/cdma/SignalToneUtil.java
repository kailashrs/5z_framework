...
public class SignalToneUtil
{
  ...
  public static int getAudioToneFromSignalInfo(int paramInt1, int paramInt2, int paramInt3)
  {
    Integer localInteger = (Integer)mHm.get(signalParamHash(paramInt1, paramInt2, paramInt3));
  ...
  private static Integer signalParamHash(int paramInt1, int paramInt2, int paramInt3)
  {
    if ((paramInt1 >= 0) && (paramInt1 <= 256) && (paramInt2 <= 256) && (paramInt2 >= 0) && (paramInt3 <= 256) && (paramInt3 >= 0))
    {
      if (paramInt1 != 2) {
        paramInt2 = 0;
      }
      return new Integer(paramInt1 * 256 * 256 + paramInt2 * 256 + paramInt3);
    }
