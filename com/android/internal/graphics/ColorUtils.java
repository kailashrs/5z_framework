...
public final class ColorUtils
{
  ...
  private static int binaryAlphaSearch(int paramInt1, int paramInt2, float paramFloat, ContrastCalculator paramContrastCalculator)
  {
    int i = 0;
    int j = 0;
    int k = 255;
    ...
    {
      int m = (j + k) / 2;
      if (paramContrastCalculator.calculateContrast(paramInt1, paramInt2, m) < paramFloat) {
        j = m;
      } else {
        k = m;
      }
  ...
  public static int calculateMinimumAlpha(int paramInt1, int paramInt2, float paramFloat)
  {
    if (Color.alpha(paramInt2) == 255)
    {
      localObject = _..Lambda.ColorUtils.r4F1J7Y711kBAemoOw8QHbDba_8.INSTANCE;
      if (((ContrastCalculator)localObject).calculateContrast(paramInt1, paramInt2, 255) < paramFloat) {
        return -1;
      }
      return binaryAlphaSearch(setAlphaComponent(paramInt1, 255), paramInt2, paramFloat, (ContrastCalculator)localObject);
    }
  ...
  public static int calculateMinimumBackgroundAlpha(int paramInt1, int paramInt2, float paramFloat)
  {
    return binaryAlphaSearch(paramInt1, setAlphaComponent(paramInt2, 255), paramFloat, new _..Lambda.ColorUtils.zbDH_52c8D9XBeqmvTHi3Boxl14(setAlphaComponent(paramInt1, 255)));
  }
  ...
  private static abstract interface ContrastCalculator
  {
    public abstract double calculateContrast(int paramInt1, int paramInt2, int paramInt3);
  }
}
