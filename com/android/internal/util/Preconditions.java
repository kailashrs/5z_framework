...
public class Preconditions
{
  ...
  public static float checkArgumentInRange(float paramFloat1, float paramFloat2, float paramFloat3, String paramString)
  {
    if (!Float.isNaN(paramFloat1))
    {
      if (paramFloat1 >= paramFloat2)
      {
        ...
        throw new IllegalArgumentException(String.format("%s is out of range of [%f, %f] (too high)", new Object[] { paramString, Float.valueOf(paramFloat2), Float.valueOf(paramFloat3) }));
      }
      throw new IllegalArgumentException(String.format("%s is out of range of [%f, %f] (too low)", new Object[] { paramString, Float.valueOf(paramFloat2), Float.valueOf(paramFloat3) }));
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramString);
    localStringBuilder.append(" must not be NaN");
  ...
  public static int checkArgumentInRange(int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    if (paramInt1 >= paramInt2)
    {
      ...
      throw new IllegalArgumentException(String.format("%s is out of range of [%d, %d] (too high)", new Object[] { paramString, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) }));
    }
    throw new IllegalArgumentException(String.format("%s is out of range of [%d, %d] (too low)", new Object[] { paramString, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) }));
  }
  ...
  public static long checkArgumentInRange(long paramLong1, long paramLong2, long paramLong3, String paramString)
  {
    if (paramLong1 >= paramLong2)
    {
      ...
      throw new IllegalArgumentException(String.format("%s is out of range of [%d, %d] (too high)", new Object[] { paramString, Long.valueOf(paramLong2), Long.valueOf(paramLong3) }));
    }
    throw new IllegalArgumentException(String.format("%s is out of range of [%d, %d] (too low)", new Object[] { paramString, Long.valueOf(paramLong2), Long.valueOf(paramLong3) }));
  }
      ...
      if (!Float.isNaN(f))
      {
        if (f >= paramFloat1)
        {
          if (f <= paramFloat2) {
            ...
            throw new IllegalArgumentException(String.format("%s[%d] is out of range of [%f, %f] (too high)", new Object[] { paramString, Integer.valueOf(i), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) }));
          }
        }
        else {
          throw new IllegalArgumentException(String.format("%s[%d] is out of range of [%f, %f] (too low)", new Object[] { paramString, Integer.valueOf(i), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) }));
        }
      }
      else
      {
  ...
  public static int[] checkArrayElementsInRange(int[] paramArrayOfInt, int paramInt1, int paramInt2, String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramString);
    localStringBuilder.append(" must not be null");
    checkNotNull(paramArrayOfInt, localStringBuilder.toString());
    int i = 0;
    while (i < paramArrayOfInt.length)
    {
      ...
      if (j >= paramInt1)
      {
        if (j <= paramInt2) {
          ...
          throw new IllegalArgumentException(String.format("%s[%d] is out of range of [%d, %d] (too high)", new Object[] { paramString, Integer.valueOf(i), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
        }
      }
      else {
        throw new IllegalArgumentException(String.format("%s[%d] is out of range of [%d, %d] (too low)", new Object[] { paramString, Integer.valueOf(i), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
      }
    }
    ...
    if (paramArrayOfT != null)
    {
      ...
      while (i < paramArrayOfT.length) {
        if (paramArrayOfT[i] != null) {
          ...
          throw new NullPointerException(String.format("%s[%d] must not be null", new Object[] { paramString, Integer.valueOf(i) }));
        }
      }
    ...
    if (paramC != null)
    {
      ...
      while (localIterator.hasNext()) {
        if (localIterator.next() != null) {
          ...
          throw new NullPointerException(String.format("%s[%d] must not be null", new Object[] { paramString, Long.valueOf(l) }));
        }
      }
      return paramC;
    }
