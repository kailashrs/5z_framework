...
public final class MessageNanoPrinter
{
  ...
  public static <T extends MessageNano> String print(T paramT)
  {
    ...
    catch (IllegalAccessException localIllegalAccessException)
    {
      paramT = new StringBuilder();
      paramT.append("Error printing proto: ");
      paramT.append(localIllegalAccessException.getMessage());
    }
    return paramT.toString();
  }
    ...
    throws IllegalAccessException, InvocationTargetException
  {
    ...
    //   30: aload_3
    //   31: aload_0
    //   32: invokestatic 113	com/android/framework/protobuf/nano/MessageNanoPrinter:deCamelCaseify	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   184: if_acmpne +23 -> 207
    //   187: aload 11
    //   189: aload 9
    //   191: aload_2
    //   192: aload_3
    //   193: invokestatic 94	com/android/framework/protobuf/nano/MessageNanoPrinter:print	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    //   196: iload 7
    //   198: istore 10
    //   200: iload 10
    //   202: istore 7
    ...
    //   215: goto +10 -> 225
    //   218: aload 9
    //   220: invokestatic 174	java/lang/reflect/Array:getLength	(Ljava/lang/Object;)I
    //   223: istore 13
    //   225: iconst_0
    //   226: istore 14
    //   228: aload 6
    ...
    //   256: aload_2
    //   257: aload_3
    //   258: invokestatic 94	com/android/framework/protobuf/nano/MessageNanoPrinter:print	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    //   261: iinc 14 1
    //   264: aload 12
    //   266: astore 6
    //   268: goto -40 -> 228
    ...
    //   278: aload_2
    //   279: aload_3
    //   280: invokestatic 94	com/android/framework/protobuf/nano/MessageNanoPrinter:print	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    //   283: iinc 8 1
    //   286: goto -212 -> 74
    //   289: aload 5
    ...
    //   465: aload_2
    //   466: aload_3
    //   467: invokestatic 94	com/android/framework/protobuf/nano/MessageNanoPrinter:print	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    //   470: goto +23 -> 493
    //   473: astore 12
    //   475: goto +5 -> 480
    //   478: astore 12
    ...
    //   536: astore_1
    //   537: aload_0
    //   538: invokestatic 113	com/android/framework/protobuf/nano/MessageNanoPrinter:deCamelCaseify	(Ljava/lang/String;)Ljava/lang/String;
    //   541: astore_0
    //   542: aload_1
    ...
    //   553: astore 6
    //   555: aload 6
    //   557: invokeinterface 228 1 0
    //   562: ifeq +94 -> 656
    //   565: aload 6
    //   567: invokeinterface 232 1 0
    //   572: checkcast 234	java/util/Map$Entry
    //   575: astore_1
    //   576: aload_3
    //   577: aload_2
    //   578: invokevirtual 111	java/lang/StringBuffer:append	(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;
    //   581: pop
    //   582: aload_3
    //   583: aload_0
    //   584: invokevirtual 26	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   587: pop
    //   588: aload_3
    //   589: ldc 115
    //   591: invokevirtual 26	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   594: pop
    //   595: aload_2
    //   596: invokevirtual 108	java/lang/StringBuffer:length	()I
    //   599: istore 7
    //   601: aload_2
    //   602: ldc 8
    //   604: invokevirtual 26	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   607: pop
    //   608: ldc -20
    //   610: aload_1
    //   611: invokeinterface 239 1 0
    //   616: aload_2
    //   617: aload_3
    //   618: invokestatic 94	com/android/framework/protobuf/nano/MessageNanoPrinter:print	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    //   621: ldc -15
    //   623: aload_1
    //   624: invokeinterface 244 1 0
    //   629: aload_2
    //   630: aload_3
    //   631: invokestatic 94	com/android/framework/protobuf/nano/MessageNanoPrinter:print	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    //   634: aload_2
    //   635: iload 7
    ...
    //   656: goto +97 -> 753
    //   659: aload_0
    //   660: invokestatic 113	com/android/framework/protobuf/nano/MessageNanoPrinter:deCamelCaseify	(Ljava/lang/String;)Ljava/lang/String;
    //   663: astore_0
    //   664: aload_3
    //   665: aload_2
    ...
    //   694: invokestatic 249	com/android/framework/protobuf/nano/MessageNanoPrinter:sanitizeString	(Ljava/lang/String;)Ljava/lang/String;
    //   697: astore_0
    //   698: aload_3
    //   699: ldc -5
    ...
    //   729: checkcast 253	[B
    //   732: aload_3
    //   733: invokestatic 255	com/android/framework/protobuf/nano/MessageNanoPrinter:appendQuotedBytes	([BLjava/lang/StringBuffer;)V
    //   736: goto +9 -> 745
    //   739: aload_3
    //   740: aload_1
