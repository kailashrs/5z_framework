...
public abstract interface EGL10
  extends EGL
{
  ...
  public static final EGLContext EGL_NO_CONTEXT = new EGLContextImpl(0L);
  public static final EGLDisplay EGL_NO_DISPLAY = new EGLDisplayImpl(0L);
  public static final EGLSurface EGL_NO_SURFACE = new EGLSurfaceImpl(0L);
  ...
  public abstract boolean eglChooseConfig(EGLDisplay paramEGLDisplay, int[] paramArrayOfInt1, EGLConfig[] paramArrayOfEGLConfig, int paramInt, int[] paramArrayOfInt2);
  
  public abstract boolean eglCopyBuffers(EGLDisplay paramEGLDisplay, EGLSurface paramEGLSurface, Object paramObject);
  
  public abstract EGLContext eglCreateContext(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, EGLContext paramEGLContext, int[] paramArrayOfInt);
  
  public abstract EGLSurface eglCreatePbufferSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, int[] paramArrayOfInt);
  
  @Deprecated
  public abstract EGLSurface eglCreatePixmapSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt);
  
  public abstract EGLSurface eglCreateWindowSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt);
  
  public abstract boolean eglDestroyContext(EGLDisplay paramEGLDisplay, EGLContext paramEGLContext);
  
  public abstract boolean eglDestroySurface(EGLDisplay paramEGLDisplay, EGLSurface paramEGLSurface);
  
  public abstract boolean eglGetConfigAttrib(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, int paramInt, int[] paramArrayOfInt);
  
  public abstract boolean eglGetConfigs(EGLDisplay paramEGLDisplay, EGLConfig[] paramArrayOfEGLConfig, int paramInt, int[] paramArrayOfInt);
  
  public abstract EGLContext eglGetCurrentContext();
  
  public abstract EGLDisplay eglGetCurrentDisplay();
  
  public abstract EGLSurface eglGetCurrentSurface(int paramInt);
  
  public abstract EGLDisplay eglGetDisplay(Object paramObject);
  
  public abstract int eglGetError();
  
  public abstract boolean eglInitialize(EGLDisplay paramEGLDisplay, int[] paramArrayOfInt);
  
  public abstract boolean eglMakeCurrent(EGLDisplay paramEGLDisplay, EGLSurface paramEGLSurface1, EGLSurface paramEGLSurface2, EGLContext paramEGLContext);
  
  public abstract boolean eglQueryContext(EGLDisplay paramEGLDisplay, EGLContext paramEGLContext, int paramInt, int[] paramArrayOfInt);
  
  public abstract String eglQueryString(EGLDisplay paramEGLDisplay, int paramInt);
  
  public abstract boolean eglQuerySurface(EGLDisplay paramEGLDisplay, EGLSurface paramEGLSurface, int paramInt, int[] paramArrayOfInt);
  
  public abstract boolean eglReleaseThread();
  
  public abstract boolean eglSwapBuffers(EGLDisplay paramEGLDisplay, EGLSurface paramEGLSurface);
  
  public abstract boolean eglTerminate(EGLDisplay paramEGLDisplay);
  
  public abstract boolean eglWaitGL();
  
  public abstract boolean eglWaitNative(int paramInt, Object paramObject);
}
