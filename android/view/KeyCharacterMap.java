  ...
  implements Parcelable
{
  ...
  private KeyCharacterMap(Parcel paramParcel)
  {
    if (paramParcel != null)
    {
      mPtr = nativeReadFromParcel(paramParcel);
      if (mPtr != 0L) {
        return;
      }
  ...
  public int get(int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = nativeGetCharacter(mPtr, paramInt1, paramInt2);
    paramInt1 = sCombiningToAccent.get(paramInt2);
    if (paramInt1 != 0) {
      return 0x80000000 | paramInt1;
    }
    return paramInt2;
  }
  ...
  {
    return nativeGetDisplayLabel(mPtr, paramInt);
  }
  
  public KeyEvent[] getEvents(char[] paramArrayOfChar)
  {
    if (paramArrayOfChar != null) {
      return nativeGetEvents(mPtr, paramArrayOfChar);
    }
  ...
  public FallbackAction getFallbackAction(int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = KeyEvent.normalizeMetaState(paramInt2);
    if (nativeGetFallbackAction(mPtr, paramInt1, paramInt2, localFallbackAction))
    {
  ...
  public boolean getKeyData(int paramInt, KeyData paramKeyData)
  {
    if (meta.length >= 4)
    {
      int i = nativeGetDisplayLabel(mPtr, paramInt);
      if (i == 0) {
        return false;
      }
      displayLabel = ((char)i);
      number = nativeGetNumber(mPtr, paramInt);
      meta[0] = nativeGetCharacter(mPtr, paramInt, 0);
      meta[1] = nativeGetCharacter(mPtr, paramInt, 1);
      meta[2] = nativeGetCharacter(mPtr, paramInt, 2);
      meta[3] = nativeGetCharacter(mPtr, paramInt, 3);
      return true;
    }
  ...
  public char getMatch(int paramInt1, char[] paramArrayOfChar, int paramInt2)
  {
    ...
    {
      paramInt2 = KeyEvent.normalizeMetaState(paramInt2);
      return nativeGetMatch(mPtr, paramInt1, paramArrayOfChar, paramInt2);
    }
    throw new IllegalArgumentException("chars must not be null.");
  }
  ...
  {
    return nativeGetNumber(mPtr, paramInt);
  }
  
  public boolean isPrintingKey(int paramInt)
  {
    switch (Character.getType(nativeGetDisplayLabel(mPtr, paramInt)))
    {
    default: 
      return true;
    }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    if (paramParcel != null)
    {
      nativeWriteToParcel(mPtr, paramParcel);
      return;
    }
    throw new IllegalArgumentException("parcel must not be null");
  }
