...
public final class Manifest
{
  ...
  public static final class permission
  {
    ...
    public static final String BROADCASTRECEIVER_ASUS_KEY = "com.asus.permission.BROADCASTRECEIVER_ASUS_KEY";
    @SystemApi
    @Deprecated
    ...
    public static final String FORCE_START_APPS = "com.asus.permission.FORCE_START_APPS";
    @SystemApi
    ...
    public static final String GET_BATTERY_STATS_INFO = "com.asus.permission.GET_BATTERY_STATS_INFO";
    ...
    public static final String HARDWARE_PROPERTIES = "com.asus.permission.HARDWARE_PROPERTIES";
    @SystemApi
    ...
    public static final String HIDE_NAVIGATION_FOREVER = "com.asus.permission.HIDE_NAVIGATION_FOREVER";
    @SystemApi
    ...
    public static final String MANAGE_APP_ASPECT = "com.asus.permission.MANAGE_APP_ASPECT";
    ...
    public static final String MARKETS = "com.asus.permission.MARKETS";
    @SystemApi
    ...
    public static final String OPTIFLEX = "com.asus.permission.OPTIFLEX";
    @SystemApi
