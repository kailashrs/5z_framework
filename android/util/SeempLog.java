...
public final class SeempLog
{
  ...
  static
  {
    value_to_get_map.put("notification_sound", Integer.valueOf(170));
    value_to_get_map.put("dtmf_tone", Integer.valueOf(132));
    ...
    value_to_get_map.put("setup_wizard_has_run", Integer.valueOf(131));
    ...
    value_to_get_map.put("alarm_alert", Integer.valueOf(103));
    value_to_get_map.put("vibrate_on", Integer.valueOf(158));
    ...
    value_to_get_map.put("font_scale", Integer.valueOf(109));
    ...
    value_to_get_map.put("accelerometer_rotation", Integer.valueOf(96));
    value_to_get_map.put("wifi_watchdog_ping_timeout_ms", Integer.valueOf(198));
    value_to_get_map.put("volume_notification", Integer.valueOf(163));
    ...
    value_to_get_map.put("wifi_static_ip", Integer.valueOf(185));
    value_to_get_map.put("bluetooth", Integer.valueOf(147));
    value_to_get_map.put("bluetooth_discoverability_timeout", Integer.valueOf(128));
    value_to_get_map.put("volume_ring", Integer.valueOf(164));
    value_to_get_map.put("mode_ringer_streams_affected", Integer.valueOf(168));
    value_to_get_map.put("volume_system", Integer.valueOf(165));
    value_to_get_map.put("screen_off_timeout", Integer.valueOf(114));
    value_to_get_map.put("wifi", Integer.valueOf(150));
    value_to_get_map.put("auto_time_zone", Integer.valueOf(124));
    value_to_get_map.put("auto_caps", Integer.valueOf(153));
    value_to_get_map.put("wallpaper_activity", Integer.valueOf(118));
    ...
    value_to_get_map.put("volume_voice", Integer.valueOf(166));
    value_to_get_map.put("debug_app", Integer.valueOf(99));
    value_to_get_map.put("wifi_on", Integer.valueOf(177));
    value_to_get_map.put("show_password", Integer.valueOf(156));
    ...
    value_to_get_map.put("volume_music", Integer.valueOf(162));
    ...
    value_to_get_map.put("end_button_behavior", Integer.valueOf(133));
    value_to_get_map.put("next_alarm_formatted", Integer.valueOf(104));
    ...
    value_to_get_map.put("bluetooth_discoverability", Integer.valueOf(127));
    value_to_get_map.put("wifi_static_dns1", Integer.valueOf(182));
    value_to_get_map.put("wifi_static_dns2", Integer.valueOf(183));
    value_to_get_map.put("haptic_feedback_enabled", Integer.valueOf(159));
    value_to_get_map.put("show_web_suggestions", Integer.valueOf(120));
    value_to_get_map.put("parental_control_redirect_url", Integer.valueOf(146));
    value_to_get_map.put("date_format", Integer.valueOf(125));
    ...
    value_to_get_map.put("time_12_24", Integer.valueOf(126));
    value_to_get_map.put("wifi_watchdog_initial_ignored_ping_count", Integer.valueOf(193));
    value_to_get_map.put("volume_bluetooth_sco", Integer.valueOf(161));
    value_to_get_map.put("user_rotation", Integer.valueOf(97));
    value_to_get_map.put("wifi_static_gateway", Integer.valueOf(184));
    value_to_get_map.put("stay_on_while_plugged_in", Integer.valueOf(117));
    value_to_get_map.put("sound_effects_enabled", Integer.valueOf(167));
    ...
    value_to_get_map.put("wifi_use_static_ip", Integer.valueOf(187));
    value_to_get_map.put("dim_screen", Integer.valueOf(115));
    value_to_get_map.put("volume_alarm", Integer.valueOf(160));
    value_to_get_map.put("wifi_watchdog_on", Integer.valueOf(195));
    value_to_get_map.put("wifi_static_netmask", Integer.valueOf(186));
    value_to_get_map.put("network_preference", Integer.valueOf(141));
    value_to_get_map.put("show_processes", Integer.valueOf(119));
    value_to_get_map.put("auto_replace", Integer.valueOf(155));
    value_to_get_map.put("wifi_networks_available_notification_on", Integer.valueOf(174));
    value_to_get_map.put("_last_audible", Integer.valueOf(171));
    value_to_get_map.put("SHOW_GTALK_SERVICE_STATUS", Integer.valueOf(121));
    value_to_get_map.put("screen_brightness", Integer.valueOf(110));
    value_to_get_map.put("use_google_mail", Integer.valueOf(122));
    value_to_get_map.put("ringtone", Integer.valueOf(134));
    value_to_get_map.put("logging_id", Integer.valueOf(106));
    value_to_get_map.put("mode_ringer", Integer.valueOf(135));
    value_to_get_map.put("mute_streams_affected", Integer.valueOf(169));
    value_to_get_map.put("wifi_watchdog_acceptable_packet_loss_percentage", Integer.valueOf(188));
    value_to_get_map.put("auto_punctuate", Integer.valueOf(154));
    value_to_get_map.put("wifi_mobile_data_transition_wakelock_timeout_ms", Integer.valueOf(173));
    value_to_get_map.put("screen_brightness_mode", Integer.valueOf(111));
    value_to_put_map = new HashMap(198);
    value_to_put_map.put("notification_sound", Integer.valueOf(274));
    value_to_put_map.put("dtmf_tone", Integer.valueOf(236));
    ...
    value_to_put_map.put("setup_wizard_has_run", Integer.valueOf(235));
    ...
    value_to_put_map.put("alarm_alert", Integer.valueOf(206));
    value_to_put_map.put("vibrate_on", Integer.valueOf(262));
    ...
    value_to_put_map.put("font_scale", Integer.valueOf(213));
    ...
    value_to_put_map.put("accelerometer_rotation", Integer.valueOf(199));
    value_to_put_map.put("wifi_watchdog_ping_timeout_ms", Integer.valueOf(302));
    value_to_put_map.put("volume_notification", Integer.valueOf(267));
    ...
    value_to_put_map.put("wifi_static_ip", Integer.valueOf(289));
    value_to_put_map.put("bluetooth", Integer.valueOf(251));
    value_to_put_map.put("bluetooth_discoverability_timeout", Integer.valueOf(232));
    value_to_put_map.put("volume_ring", Integer.valueOf(268));
    value_to_put_map.put("mode_ringer_streams_affected", Integer.valueOf(272));
    value_to_put_map.put("volume_system", Integer.valueOf(269));
    value_to_put_map.put("screen_off_timeout", Integer.valueOf(218));
    value_to_put_map.put("wifi", Integer.valueOf(254));
    value_to_put_map.put("auto_time_zone", Integer.valueOf(228));
    value_to_put_map.put("auto_caps", Integer.valueOf(257));
    value_to_put_map.put("wallpaper_activity", Integer.valueOf(222));
    ...
    value_to_put_map.put("volume_voice", Integer.valueOf(270));
    value_to_put_map.put("debug_app", Integer.valueOf(202));
    value_to_put_map.put("wifi_on", Integer.valueOf(281));
    value_to_put_map.put("show_password", Integer.valueOf(260));
    ...
    value_to_put_map.put("volume_music", Integer.valueOf(266));
    ...
    value_to_put_map.put("end_button_behavior", Integer.valueOf(237));
    value_to_put_map.put("next_alarm_formatted", Integer.valueOf(207));
    ...
    value_to_put_map.put("bluetooth_discoverability", Integer.valueOf(231));
    value_to_put_map.put("wifi_static_dns1", Integer.valueOf(286));
    value_to_put_map.put("wifi_static_dns2", Integer.valueOf(287));
    value_to_put_map.put("haptic_feedback_enabled", Integer.valueOf(263));
    value_to_put_map.put("show_web_suggestions", Integer.valueOf(224));
    value_to_put_map.put("parental_control_redirect_url", Integer.valueOf(250));
    value_to_put_map.put("date_format", Integer.valueOf(229));
    ...
    value_to_put_map.put("time_12_24", Integer.valueOf(230));
    value_to_put_map.put("wifi_watchdog_initial_ignored_ping_count", Integer.valueOf(297));
    value_to_put_map.put("volume_bluetooth_sco", Integer.valueOf(265));
    value_to_put_map.put("user_rotation", Integer.valueOf(200));
    value_to_put_map.put("wifi_static_gateway", Integer.valueOf(288));
    value_to_put_map.put("stay_on_while_plugged_in", Integer.valueOf(221));
    value_to_put_map.put("sound_effects_enabled", Integer.valueOf(271));
    ...
    value_to_put_map.put("wifi_use_static_ip", Integer.valueOf(291));
    value_to_put_map.put("dim_screen", Integer.valueOf(219));
    value_to_put_map.put("volume_alarm", Integer.valueOf(264));
    value_to_put_map.put("wifi_watchdog_on", Integer.valueOf(299));
    value_to_put_map.put("wifi_static_netmask", Integer.valueOf(290));
    value_to_put_map.put("network_preference", Integer.valueOf(245));
    value_to_put_map.put("show_processes", Integer.valueOf(223));
    value_to_put_map.put("auto_replace", Integer.valueOf(259));
    value_to_put_map.put("wifi_networks_available_notification_on", Integer.valueOf(278));
    value_to_put_map.put("_last_audible", Integer.valueOf(275));
    value_to_put_map.put("SHOW_GTALK_SERVICE_STATUS", Integer.valueOf(225));
    value_to_put_map.put("screen_brightness", Integer.valueOf(214));
    value_to_put_map.put("use_google_mail", Integer.valueOf(226));
    value_to_put_map.put("ringtone", Integer.valueOf(238));
    value_to_put_map.put("logging_id", Integer.valueOf(210));
    value_to_put_map.put("mode_ringer", Integer.valueOf(239));
    value_to_put_map.put("mute_streams_affected", Integer.valueOf(273));
    value_to_put_map.put("wifi_watchdog_acceptable_packet_loss_percentage", Integer.valueOf(292));
    value_to_put_map.put("auto_punctuate", Integer.valueOf(258));
    value_to_put_map.put("wifi_mobile_data_transition_wakelock_timeout_ms", Integer.valueOf(277));
    value_to_put_map.put("screen_brightness_mode", Integer.valueOf(215));
  }
  
  private SeempLog() {}
  
  public static int getSeempGetApiIdFromValue(String paramString)
  {
    Integer localInteger = (Integer)value_to_get_map.get(paramString);
  ...
  public static int getSeempPutApiIdFromValue(String paramString)
  {
    Integer localInteger = (Integer)value_to_put_map.get(paramString);
    paramString = localInteger;
    if (localInteger == null) {
      paramString = Integer.valueOf(-1);
    }
  ...
  public static int record(int paramInt)
  {
    return seemp_println_native(paramInt, "");
  }
  
  public static int record_sensor(int paramInt, Sensor paramSensor)
  {
    if (paramSensor != null)
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("sensor=");
      localStringBuilder.append(paramSensor.getType());
      return seemp_println_native(paramInt, localStringBuilder.toString());
    }
    return seemp_println_native(paramInt, "sensor=-1");
  }
  
  public static int record_sensor_rate(int paramInt1, Sensor paramSensor, int paramInt2)
  {
    if (paramSensor != null)
    {
      StringBuilder localStringBuilder = new StringBuilder();
      ...
      return seemp_println_native(paramInt1, localStringBuilder.toString());
    }
    paramSensor = new StringBuilder();
    paramSensor.append("sensor=-1,rate=");
    paramSensor.append(paramInt2);
    return seemp_println_native(paramInt1, paramSensor.toString());
  }
  
  public static int record_str(int paramInt, String paramString)
  {
    if (paramString != null) {
      return seemp_println_native(paramInt, paramString);
    }
    return seemp_println_native(paramInt, "");
  }
  
  public static int record_uri(int paramInt, Uri paramUri)
  {
    if (paramUri != null)
    {
      StringBuilder localStringBuilder = new StringBuilder();
    ...
    return seemp_println_native(paramInt, "uri, null");
  }
  
  public static int record_vg_layout(int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    try
    {
      ...
      if (paramLayoutParams != null)
      {
        ...
        localStringBuilder.append("window_type=");
        localStringBuilder.append(type);
        localStringBuilder.append(",window_flag=");
        localStringBuilder.append(flags);
        return seemp_println_native(paramInt, localStringBuilder.toString());
      }
      int i = seemp_println_native(paramInt, "");
      return i;
    }
    catch (ClassCastException paramLayoutParams) {}
    return seemp_println_native(paramInt, "");
  }
  
  public static native int seemp_println_native(int paramInt, String paramString);
}
