...
public class ToneGenerator
{
  ...
  public ToneGenerator(int paramInt1, int paramInt2)
  {
    native_setup(paramInt1, paramInt2);
  }
  
  private final native void native_finalize();
  
  private final native void native_setup(int paramInt1, int paramInt2);
  ...
  public boolean startTone(int paramInt)
  {
    return startTone(paramInt, -1);
  }
