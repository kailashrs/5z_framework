...
public final class KeymasterDefs
{
  ...
  static
  {
    ...
    sErrorCodeToString.put(Integer.valueOf(64536), "Unknown error");
  }
  ...
  {
    String str = (String)sErrorCodeToString.get(Integer.valueOf(paramInt));
    if (str != null) {
      return str;
    }
  ...
  public static int getTagType(int paramInt)
  {
