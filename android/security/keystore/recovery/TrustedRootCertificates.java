...
public final class TrustedRootCertificates
{
  ...
  private static ArrayMap<String, X509Certificate> constructRootCertificateMap()
  {
    ...
    localArrayMap.put("GoogleCloudKeyVaultServiceV1", GOOGLE_CLOUD_KEY_VAULT_SERVICE_V1_CERTIFICATE);
    return localArrayMap;
  }
  
  public static X509Certificate getRootCertificate(String paramString)
  {
    return (X509Certificate)ALL_ROOT_CERTIFICATES.get(paramString);
  }
  ...
  {
    return parseBase64Certificate("");
  }
  
  private static X509Certificate parseBase64Certificate(String paramString)
  {
    try
    {
      paramString = X509CertificateParsingUtils.decodeBase64Cert(paramString);
      return paramString;
    }
