  ...
  extends Provider
{
  ...
  AndroidKeyStoreBCWorkaroundProvider()
  {
    ...
    if ("true".equals(SystemProperties.get("ro.hardware.keystore_desede")))
    {
  ...
  private void putAsymmetricCipherImpl(String paramString1, String paramString2)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("Cipher.");
    localStringBuilder.append(paramString1);
    put(localStringBuilder.toString(), paramString2);
    paramString2 = new StringBuilder();
    paramString2.append("Cipher.");
    paramString2.append(paramString1);
    paramString2.append(" SupportedKeyClasses");
    put(paramString2.toString(), "android.security.keystore.AndroidKeyStorePrivateKey|android.security.keystore.AndroidKeyStorePublicKey");
  }
  
  private void putMacImpl(String paramString1, String paramString2)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    put(localStringBuilder.toString(), paramString2);
    paramString2 = new StringBuilder();
    paramString2.append("Mac.");
    paramString2.append(paramString1);
    paramString2.append(" SupportedKeyClasses");
    put(paramString2.toString(), "android.security.keystore.AndroidKeyStoreSecretKey");
  }
  
  private void putSignatureImpl(String paramString1, String paramString2)
  {
    StringBuilder localStringBuilder = new StringBuilder();
  ...
  private void putSymmetricCipherImpl(String paramString1, String paramString2)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("Cipher.");
    localStringBuilder.append(paramString1);
