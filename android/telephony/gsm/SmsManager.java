...
public final class SmsManager
{
  ...
  {
    SeempLog.record(82);
    return mSmsMgrProxy.copyMessageToIcc(paramArrayOfByte1, paramArrayOfByte2, paramInt);
  }
  ...
  {
    SeempLog.record(83);
    return mSmsMgrProxy.deleteMessageFromIcc(paramInt);
  }
  
  @Deprecated
  public final ArrayList<String> divideMessage(String paramString)
  {
    return mSmsMgrProxy.divideMessage(paramString);
  }
  ...
  public final void sendDataMessage(String paramString1, String paramString2, short paramShort, byte[] paramArrayOfByte, PendingIntent paramPendingIntent1, PendingIntent paramPendingIntent2)
  {
    ...
    mSmsMgrProxy.sendDataMessage(paramString1, paramString2, paramShort, paramArrayOfByte, paramPendingIntent1, paramPendingIntent2);
  }
  ...
  public final void sendMultipartTextMessage(String paramString1, String paramString2, ArrayList<String> paramArrayList, ArrayList<PendingIntent> paramArrayList1, ArrayList<PendingIntent> paramArrayList2)
  {
    ...
    mSmsMgrProxy.sendMultipartTextMessage(paramString1, paramString2, paramArrayList, paramArrayList1, paramArrayList2);
  }
  ...
  public final void sendTextMessage(String paramString1, String paramString2, String paramString3, PendingIntent paramPendingIntent1, PendingIntent paramPendingIntent2)
  {
    ...
    mSmsMgrProxy.sendTextMessage(paramString1, paramString2, paramString3, paramPendingIntent1, paramPendingIntent2);
  }
  ...
  {
    SeempLog.record(84);
    return mSmsMgrProxy.updateMessageOnIcc(paramInt1, paramInt2, paramArrayOfByte);
  }
}
