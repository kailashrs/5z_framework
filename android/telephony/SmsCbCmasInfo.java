  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<SmsCbCmasInfo> CREATOR = new Parcelable.Creator()
  {
    public SmsCbCmasInfo createFromParcel(Parcel paramAnonymousParcel)
    {
      return new SmsCbCmasInfo(paramAnonymousParcel);
    }
    
    public SmsCbCmasInfo[] newArray(int paramAnonymousInt)
    {
      return new SmsCbCmasInfo[paramAnonymousInt];
    }
  };
  ...
  {
    mMessageClass = paramInt1;
    mCategory = paramInt2;
    mResponseType = paramInt3;
    mSeverity = paramInt4;
    mUrgency = paramInt5;
    mCertainty = paramInt6;
  }
  
  SmsCbCmasInfo(Parcel paramParcel)
  {
    mMessageClass = paramParcel.readInt();
    mCategory = paramParcel.readInt();
    mResponseType = paramParcel.readInt();
    mSeverity = paramParcel.readInt();
    mUrgency = paramParcel.readInt();
    mCertainty = paramParcel.readInt();
  }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("SmsCbCmasInfo{messageClass=");
    localStringBuilder.append(mMessageClass);
    localStringBuilder.append(", category=");
    localStringBuilder.append(mCategory);
    localStringBuilder.append(", responseType=");
    localStringBuilder.append(mResponseType);
    localStringBuilder.append(", severity=");
    localStringBuilder.append(mSeverity);
    localStringBuilder.append(", urgency=");
    localStringBuilder.append(mUrgency);
    localStringBuilder.append(", certainty=");
    localStringBuilder.append(mCertainty);
  ...
  {
    paramParcel.writeInt(mMessageClass);
    paramParcel.writeInt(mCategory);
    paramParcel.writeInt(mResponseType);
    paramParcel.writeInt(mSeverity);
    paramParcel.writeInt(mUrgency);
    paramParcel.writeInt(mCertainty);
  }
}
