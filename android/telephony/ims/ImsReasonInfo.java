  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<ImsReasonInfo> CREATOR = new Parcelable.Creator()
  {
    public ImsReasonInfo createFromParcel(Parcel paramAnonymousParcel)
    {
      return new ImsReasonInfo(paramAnonymousParcel, null);
    }
    
    public ImsReasonInfo[] newArray(int paramAnonymousInt)
    {
      return new ImsReasonInfo[paramAnonymousInt];
    }
  };
  ...
  public ImsReasonInfo(int paramInt1, int paramInt2)
  {
    mCode = paramInt1;
    mExtraCode = paramInt2;
    mExtraMessage = null;
  }
  
  public ImsReasonInfo(int paramInt1, int paramInt2, String paramString)
  {
    mCode = paramInt1;
    mExtraCode = paramInt2;
    mExtraMessage = paramString;
  }
  
  private ImsReasonInfo(Parcel paramParcel)
  {
    mCode = paramParcel.readInt();
    mExtraCode = paramParcel.readInt();
    mExtraMessage = paramParcel.readString();
  }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("ImsReasonInfo :: {");
    localStringBuilder.append(mCode);
    localStringBuilder.append(", ");
    localStringBuilder.append(mExtraCode);
    localStringBuilder.append(", ");
    localStringBuilder.append(mExtraMessage);
    localStringBuilder.append("}");
  ...
  {
    paramParcel.writeInt(mCode);
    paramParcel.writeInt(mExtraCode);
    paramParcel.writeString(mExtraMessage);
  }
}
