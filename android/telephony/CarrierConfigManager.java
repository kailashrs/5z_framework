...
public class CarrierConfigManager
{
  ...
  public static final String KEY_ASUS_VOWIFI_NAME_OVERRIDE = "vowifi_name_override";
  ...
  public static final String KEY_CARRIER_ROAM_VOLTE_ENABLED_BOOL = "carrier_roam_volte_enabled_bool";
  ...
  public static final String KEY_CARRIER_VOLTE_ROAMING_AVAILABLE_BOOL = "carrier_volte_roaming_available_bool";
  ...
  public static final String KEY_CARRIER_WFC_IMS_ROAMING_AVAILABLE_BOOL = "carrier_wfc_ims_roaming_available_bool";
  ...
  public static final String KEY_EMERGENCY_SMS_SUPPORT_BOOL = "emergency_sms_support_bool";
  ...
  public static final String KEY_HIDE_IMS_ICON_MASK_INT = "hide_ims_icon_mask_int";
  ...
  static
  {
    ...
    sDefaults.putBoolean("carrier_volte_roaming_available_bool", false);
    sDefaults.putBoolean("carrier_roam_volte_enabled_bool", true);
    ...
    sDefaults.putString("vowifi_name_override", "");
    ...
    sDefaults.putBoolean("carrier_wfc_ims_roaming_available_bool", false);
    sDefaults.putBoolean("carrier_wfc_supports_wifi_only_bool", false);
    sDefaults.putBoolean("carrier_default_wfc_ims_enabled_bool", true);
    ...
    sDefaults.putStringArray("read_only_apn_types_string_array", null);
    ...
    sDefaults.putLong("message_expiration_time_long", 86400000L);
    ...
    sDefaults.putStringArray("carrier_metered_iwlan_apn_types_strings", new String[] { "default" });
    ...
    sDefaults.putInt("hide_ims_icon_mask_int", 0);
    ...
    sDefaults.putBoolean("support_enhanced_call_blocking_bool", false);
    ...
    PersistableBundle localPersistableBundle = sDefaults;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(String.valueOf(false));
    localStringBuilder.append(": 7");
    String str = localStringBuilder.toString();
    localStringBuilder = new StringBuilder();
    localStringBuilder.append(String.valueOf(true));
    localStringBuilder.append(": 8");
    localPersistableBundle.putStringArray("carrier_default_actions_on_default_network_available_string_array", new String[] { str, localStringBuilder.toString() });
    ...
    sDefaults.putBoolean("editable_wfc_roaming_mode_bool", true);
    sDefaults.putBoolean("stk_disable_launch_browser_bool", false);
    sDefaults.putBoolean("persist_lpp_mode_bool", true);
    ...
    sDefaults.putIntArray("lte_rsrp_thresholds_int_array", new int[] { -126, -119, -114, -109, -100, -90, -80, -70 });
    sDefaults.putIntArray("wcdma_rscp_thresholds_int_array", new int[] { -114, -106, -101, -96, -89, -79, -69, -59 });
    sDefaults.putString("wcdma_default_signal_strength_measurement_string", "");
  }
  ...
  public PersistableBundle getConfigForSubId(int paramInt)
  {
    try
    {
      Object localObject = getICarrierConfigLoader();
      if (localObject == null)
      {
        localObject = new java/lang/StringBuilder;
        ((StringBuilder)localObject).<init>();
        ((StringBuilder)localObject).append("Error getting config for subId ");
        ((StringBuilder)localObject).append(paramInt);
        ((StringBuilder)localObject).append(" ICarrierConfigLoader is null");
        Rlog.w("CarrierConfigManager", ((StringBuilder)localObject).toString());
        return null;
      }
      localObject = ((ICarrierConfigLoader)localObject).getConfigForSubId(paramInt);
      return localObject;
    }
    catch (RemoteException localRemoteException)
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("Error getting config for subId ");
      localStringBuilder.append(paramInt);
      localStringBuilder.append(": ");
      localStringBuilder.append(localRemoteException.toString());
      Rlog.e("CarrierConfigManager", localStringBuilder.toString());
    }
    return null;
  }
  ...
  public String getDefaultCarrierServicePackageName()
  {
    try
    {
      String str = getICarrierConfigLoader().getDefaultCarrierServicePackageName();
      return str;
    }
  ...
  public boolean isCarrierConfigVaild(int paramInt)
  {
    try
    {
      boolean bool = getICarrierConfigLoader().isCarrierConfigVaild(paramInt);
      return bool;
    }
  ...
  public void notifyConfigChangedForSubId(int paramInt)
  {
    try
    {
      ...
      if (localObject == null)
      {
        localObject = new java/lang/StringBuilder;
        ((StringBuilder)localObject).<init>();
        ((StringBuilder)localObject).append("Error reloading config for subId=");
        ((StringBuilder)localObject).append(paramInt);
        ((StringBuilder)localObject).append(" ICarrierConfigLoader is null");
        Rlog.w("CarrierConfigManager", ((StringBuilder)localObject).toString());
        return;
      }
      ((ICarrierConfigLoader)localObject).notifyConfigChangedForSubId(paramInt);
    }
    catch (RemoteException localRemoteException)
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("Error reloading config for subId=");
      localStringBuilder.append(paramInt);
      localStringBuilder.append(": ");
      localStringBuilder.append(localRemoteException.toString());
      Rlog.e("CarrierConfigManager", localStringBuilder.toString());
  ...
  public void updateConfigForPhoneId(int paramInt, String paramString)
  {
    try
    {
      localObject = getICarrierConfigLoader();
      if (localObject == null)
      {
        paramString = new java/lang/StringBuilder;
        paramString.<init>();
        paramString.append("Error updating config for phoneId=");
        paramString.append(paramInt);
        paramString.append(" ICarrierConfigLoader is null");
        Rlog.w("CarrierConfigManager", paramString.toString());
        return;
      }
      ((ICarrierConfigLoader)localObject).updateConfigForPhoneId(paramInt, paramString);
    }
    catch (RemoteException paramString)
    {
      Object localObject = new StringBuilder();
      ((StringBuilder)localObject).append("Error updating config for phoneId=");
      ((StringBuilder)localObject).append(paramInt);
      ((StringBuilder)localObject).append(": ");
      ((StringBuilder)localObject).append(paramString.toString());
      Rlog.e("CarrierConfigManager", ((StringBuilder)localObject).toString());
    }
  }
}
