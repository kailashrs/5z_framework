...
public abstract interface IUsbGadget
  extends IBase
{
  public static final String kInterfaceName = "android.hardware.usb.gadget@1.0::IUsbGadget";
  
  public static IUsbGadget asInterface(IHwBinder paramIHwBinder)
  {
    if (paramIHwBinder == null) {
      return null;
    }
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.usb.gadget@1.0::IUsbGadget");
    if ((localObject != null) && ((localObject instanceof IUsbGadget))) {
      return (IUsbGadget)localObject;
    }
    localObject = new Proxy(paramIHwBinder);
    try
    {
      paramIHwBinder = ((IUsbGadget)localObject).interfaceChain().iterator();
      while (paramIHwBinder.hasNext())
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.usb.gadget@1.0::IUsbGadget");
        if (bool) {
          return localObject;
        }
      }
  ...
  public static IUsbGadget castFrom(IHwInterface paramIHwInterface)
  {
  ...
  public static IUsbGadget getService()
    throws RemoteException
  {
    return getService("default");
  }
  
  public static IUsbGadget getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.usb.gadget@1.0::IUsbGadget", paramString));
  }
  
  public static IUsbGadget getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.usb.gadget@1.0::IUsbGadget", paramString, paramBoolean));
  }
  
  public static IUsbGadget getService(boolean paramBoolean)
    throws RemoteException
  {
  ...
  public abstract void getCurrentUsbFunctions(IUsbGadgetCallback paramIUsbGadgetCallback)
    throws RemoteException;
  ...
  public abstract void setCurrentUsbFunctions(long paramLong1, IUsbGadgetCallback paramIUsbGadgetCallback, long paramLong2)
    throws RemoteException;
    ...
    implements IUsbGadget
  {
    ...
    public void getCurrentUsbFunctions(IUsbGadgetCallback paramIUsbGadgetCallback)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.usb.gadget@1.0::IUsbGadget");
      if (paramIUsbGadgetCallback == null) {
        paramIUsbGadgetCallback = null;
      } else {
        paramIUsbGadgetCallback = paramIUsbGadgetCallback.asBinder();
      }
      localHwParcel.writeStrongBinder(paramIUsbGadgetCallback);
      paramIUsbGadgetCallback = new HwParcel();
      try
      {
        mRemote.transact(2, localHwParcel, paramIUsbGadgetCallback, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
      {
        paramIUsbGadgetCallback.release();
      }
    }
    ...
    public void setCurrentUsbFunctions(long paramLong1, IUsbGadgetCallback paramIUsbGadgetCallback, long paramLong2)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.usb.gadget@1.0::IUsbGadget");
      localHwParcel.writeInt64(paramLong1);
      if (paramIUsbGadgetCallback == null) {
        paramIUsbGadgetCallback = null;
      } else {
        paramIUsbGadgetCallback = paramIUsbGadgetCallback.asBinder();
      ...
      localHwParcel.writeStrongBinder(paramIUsbGadgetCallback);
      localHwParcel.writeInt64(paramLong2);
      paramIUsbGadgetCallback = new HwParcel();
      try
      {
        mRemote.transact(1, localHwParcel, paramIUsbGadgetCallback, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
    ...
    implements IUsbGadget
  {
    ...
    public final ArrayList<byte[]> getHashChain()
    {
      ...
      return new ArrayList(Arrays.asList(new byte[][] { { -115, -33, -89, 84, 39, 114, -52, 123, -54, 25, -105, 43, 45, -123, 98, 100, -17, -93, 25, 20, -65, -48, -104, -82, -73, -62, 7, -99, -107, 1, -108, -53 }, arrayOfByte }));
    }
    
    public final ArrayList<String> interfaceChain()
    {
      return new ArrayList(Arrays.asList(new String[] { "android.hardware.usb.gadget@1.0::IUsbGadget", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor()
    {
      return "android.hardware.usb.gadget@1.0::IUsbGadget";
    }
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            {
                              paramHwParcel1.enforceInterface("android.hardware.usb.gadget@1.0::IUsbGadget");
                              getCurrentUsbFunctions(IUsbGadgetCallback.asInterface(paramHwParcel1.readStrongBinder()));
                              break;
                              paramInt1 = i1;
                              if ((paramInt2 & 0x1) != 0) {
                                paramInt1 = 1;
                              ...
                              {
                                paramHwParcel1.enforceInterface("android.hardware.usb.gadget@1.0::IUsbGadget");
                                setCurrentUsbFunctions(paramHwParcel1.readInt64(), IUsbGadgetCallback.asInterface(paramHwParcel1.readStrongBinder()), paramHwParcel1.readInt64());
                              }
                            }
                          }
                        }
    ...
    {
      if ("android.hardware.usb.gadget@1.0::IUsbGadget".equals(paramString)) {
        return this;
      }
      return null;
    }
