  ...
  extends android.hardware.vibrator.V1_0.IVibrator
{
  ...
  public static IVibrator asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.vibrator@1.1::IVibrator");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.vibrator@1.1::IVibrator");
        if (bool) {
          return localObject;
        }
      }
  ...
  public static IVibrator getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.vibrator@1.1::IVibrator", paramString));
  }
  
  public static IVibrator getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.vibrator@1.1::IVibrator", paramString, paramBoolean));
  }
  ...
  public abstract void perform_1_1(int paramInt, byte paramByte, perform_1_1Callback paramPerform_1_1Callback)
    throws RemoteException;
    ...
    implements IVibrator
  {
    ...
    {
      byte[] arrayOfByte = { 6, -22, 100, -52, 53, 101, 119, 127, 59, 37, -98, 64, 15, -6, 113, 0, -48, 127, 56, 39, -83, -109, 87, -80, -59, -45, -58, 81, 56, 78, 85, 83 };
      return new ArrayList(Arrays.asList(new byte[][] { { -7, 90, 30, -123, 97, 47, 45, 13, 97, 110, -84, -46, -21, 99, -59, 45, 16, -33, -88, -119, -15, 101, -33, 87, 105, 124, 48, -31, -12, 123, 71, -123 }, arrayOfByte, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
    
    public final ArrayList<String> interfaceChain()
    {
      return new ArrayList(Arrays.asList(new String[] { "android.hardware.vibrator@1.1::IVibrator", "android.hardware.vibrator@1.0::IVibrator", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor()
    {
      return "android.hardware.vibrator@1.1::IVibrator";
    }
    ...
    {
      if ("android.hardware.vibrator@1.1::IVibrator".equals(paramString)) {
        return this;
      }
      return null;
    }
  ...
  @FunctionalInterface
  public static abstract interface perform_1_1Callback
  {
