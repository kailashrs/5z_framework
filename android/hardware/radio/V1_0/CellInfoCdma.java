...
public final class CellInfoCdma
{
  ...
  public static final ArrayList<CellInfoCdma> readVectorFromParcel(HwParcel paramHwParcel)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      localCellInfoCdma.readEmbeddedFromParcel(paramHwParcel, localHwBlob, j * 40);
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<CellInfoCdma> paramArrayList)
  {
    ...
    while (j < i)
    {
      ((CellInfoCdma)paramArrayList.get(j)).writeEmbeddedToBlob(localHwBlob2, j * 40);
      j++;
    }
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong)
  {
    ...
    signalStrengthCdma.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, 20L + paramLong);
    signalStrengthEvdo.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, 28L + paramLong);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong)
  {
    ...
    signalStrengthCdma.writeEmbeddedToBlob(paramHwBlob, 20L + paramLong);
    signalStrengthEvdo.writeEmbeddedToBlob(paramHwBlob, 28L + paramLong);
  }
