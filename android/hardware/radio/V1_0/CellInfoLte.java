...
public final class CellInfoLte
{
  ...
  public static final ArrayList<CellInfoLte> readVectorFromParcel(HwParcel paramHwParcel)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      CellInfoLte localCellInfoLte = new CellInfoLte();
      localCellInfoLte.readEmbeddedFromParcel(paramHwParcel, localHwBlob, j * 72);
      localArrayList.add(localCellInfoLte);
    }
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<CellInfoLte> paramArrayList)
  {
    ...
    while (j < i)
    {
      ((CellInfoLte)paramArrayList.get(j)).writeEmbeddedToBlob(localHwBlob2, j * 72);
      j++;
    }
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong)
  {
    ...
    signalStrengthLte.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, 48L + paramLong);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong)
  {
    ...
    signalStrengthLte.writeEmbeddedToBlob(paramHwBlob, 48L + paramLong);
  }
