  ...
  extends IBase
{
  ...
  public static IRadioIndication asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.0::IRadioIndication");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.radio@1.0::IRadioIndication");
        if (bool) {
          return localObject;
        }
      }
  ...
  public static IRadioIndication getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.0::IRadioIndication", paramString));
  }
  
  public static IRadioIndication getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.0::IRadioIndication", paramString, paramBoolean));
  }
  ...
  public abstract void callRing(int paramInt, boolean paramBoolean, CdmaSignalInfoRecord paramCdmaSignalInfoRecord)
    throws RemoteException;
  
  public abstract void callStateChanged(int paramInt)
    throws RemoteException;
  
  public abstract void cdmaCallWaiting(int paramInt, CdmaCallWaiting paramCdmaCallWaiting)
    throws RemoteException;
  
  public abstract void cdmaInfoRec(int paramInt, CdmaInformationRecords paramCdmaInformationRecords)
    throws RemoteException;
  
  public abstract void cdmaNewSms(int paramInt, CdmaSmsMessage paramCdmaSmsMessage)
    throws RemoteException;
  
  public abstract void cdmaOtaProvisionStatus(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void cdmaPrlChanged(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void cdmaRuimSmsStorageFull(int paramInt)
    throws RemoteException;
  
  public abstract void cdmaSubscriptionSourceChanged(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void cellInfoList(int paramInt, ArrayList<CellInfo> paramArrayList)
    throws RemoteException;
  
  public abstract void currentSignalStrength(int paramInt, SignalStrength paramSignalStrength)
    throws RemoteException;
  
  public abstract void dataCallListChanged(int paramInt, ArrayList<SetupDataCallResult> paramArrayList)
    throws RemoteException;
  
  public abstract void enterEmergencyCallbackMode(int paramInt)
    throws RemoteException;
  ...
  public abstract void hardwareConfigChanged(int paramInt, ArrayList<HardwareConfig> paramArrayList)
    throws RemoteException;
  
  public abstract void imsNetworkStateChanged(int paramInt)
    throws RemoteException;
  
  public abstract void indicateRingbackTone(int paramInt, boolean paramBoolean)
    throws RemoteException;
  ...
  public abstract void lceData(int paramInt, LceDataInfo paramLceDataInfo)
    throws RemoteException;
  
  public abstract boolean linkToDeath(IHwBinder.DeathRecipient paramDeathRecipient, long paramLong)
    throws RemoteException;
  
  public abstract void modemReset(int paramInt, String paramString)
    throws RemoteException;
  
  public abstract void networkStateChanged(int paramInt)
    throws RemoteException;
  
  public abstract void newBroadcastSms(int paramInt, ArrayList<Byte> paramArrayList)
    throws RemoteException;
  
  public abstract void newSms(int paramInt, ArrayList<Byte> paramArrayList)
    throws RemoteException;
  
  public abstract void newSmsOnSim(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void newSmsStatusReport(int paramInt, ArrayList<Byte> paramArrayList)
    throws RemoteException;
  
  public abstract void nitzTimeReceived(int paramInt, String paramString, long paramLong)
    throws RemoteException;
  
  public abstract void notifySyspropsChanged()
    throws RemoteException;
  
  public abstract void onSupplementaryServiceIndication(int paramInt, StkCcUnsolSsResult paramStkCcUnsolSsResult)
    throws RemoteException;
  
  public abstract void onUssd(int paramInt1, int paramInt2, String paramString)
    throws RemoteException;
  
  public abstract void pcoData(int paramInt, PcoDataInfo paramPcoDataInfo)
    throws RemoteException;
  
  public abstract void ping()
    throws RemoteException;
  
  public abstract void radioCapabilityIndication(int paramInt, RadioCapability paramRadioCapability)
    throws RemoteException;
  
  public abstract void radioStateChanged(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void resendIncallMute(int paramInt)
    throws RemoteException;
  
  public abstract void restrictedStateChanged(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void rilConnected(int paramInt)
    throws RemoteException;
  
  public abstract void setHALInstrumentation()
    throws RemoteException;
  
  public abstract void simRefresh(int paramInt, SimRefreshResult paramSimRefreshResult)
    throws RemoteException;
  
  public abstract void simSmsStorageFull(int paramInt)
    throws RemoteException;
  
  public abstract void simStatusChanged(int paramInt)
    throws RemoteException;
  
  public abstract void srvccStateNotify(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void stkCallControlAlphaNotify(int paramInt, String paramString)
    throws RemoteException;
  
  public abstract void stkCallSetup(int paramInt, long paramLong)
    throws RemoteException;
  
  public abstract void stkEventNotify(int paramInt, String paramString)
    throws RemoteException;
  
  public abstract void stkProactiveCommand(int paramInt, String paramString)
    throws RemoteException;
  
  public abstract void stkSessionEnd(int paramInt)
    throws RemoteException;
  
  public abstract void subscriptionStatusChanged(int paramInt, boolean paramBoolean)
    throws RemoteException;
  
  public abstract void suppSvcNotify(int paramInt, SuppSvcNotification paramSuppSvcNotification)
    throws RemoteException;
  
  public abstract boolean unlinkToDeath(IHwBinder.DeathRecipient paramDeathRecipient)
    throws RemoteException;
  
  public abstract void voiceRadioTechChanged(int paramInt1, int paramInt2)
    throws RemoteException;
    ...
    implements IRadioIndication
  {
    ...
    {
      return new ArrayList(Arrays.asList(new byte[][] { { 92, -114, -5, -71, -60, 81, -91, -105, 55, -19, 44, 108, 32, 35, 10, -82, 71, 69, -125, -100, -96, 29, -128, -120, -42, -36, -55, 2, 14, 82, -46, -59 }, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
    
    public final ArrayList<String> interfaceChain()
    {
      return new ArrayList(Arrays.asList(new String[] { "android.hardware.radio@1.0::IRadioIndication", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor()
    {
      return "android.hardware.radio@1.0::IRadioIndication";
    }
    ...
    {
      if ("android.hardware.radio@1.0::IRadioIndication".equals(paramString)) {
        return this;
      }
      return null;
    }
