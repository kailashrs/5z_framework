...
public abstract interface IRadioIndication
  extends android.hardware.radio.V1_1.IRadioIndication
{
  ...
  public static IRadioIndication asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.2::IRadioIndication");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)((Iterator)localObject).next()).equals("android.hardware.radio@1.2::IRadioIndication");
        if (bool) {
  ...
  public abstract void cellInfoList_1_2(int paramInt, ArrayList<CellInfo> paramArrayList)
    throws RemoteException;
  
  public abstract void currentLinkCapacityEstimate(int paramInt, LinkCapacityEstimate paramLinkCapacityEstimate)
    throws RemoteException;
  
  public abstract void currentPhysicalChannelConfigs(int paramInt, ArrayList<PhysicalChannelConfig> paramArrayList)
    throws RemoteException;
  
  public abstract void currentSignalStrength_1_2(int paramInt, SignalStrength paramSignalStrength)
    throws RemoteException;
  ...
  public abstract void networkScanResult_1_2(int paramInt, NetworkScanResult paramNetworkScanResult)
    throws RemoteException;
    ...
    implements IRadioIndication
  {
    ...
    public void cellInfoList_1_2(int paramInt, ArrayList<CellInfo> paramArrayList)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
      localHwParcel.writeInt32(paramInt);
      CellInfo.writeVectorToParcel(localHwParcel, paramArrayList);
      paramArrayList = new HwParcel();
      try
      {
        mRemote.transact(50, localHwParcel, paramArrayList, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
      ...
      throws RemoteException
    {
      ...
      localHwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
      localHwParcel.writeInt32(paramInt);
      paramLinkCapacityEstimate.writeToParcel(localHwParcel);
      paramLinkCapacityEstimate = new HwParcel();
      try
      {
        mRemote.transact(51, localHwParcel, paramLinkCapacityEstimate, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
      {
        paramLinkCapacityEstimate.release();
      }
    }
    
    public void currentPhysicalChannelConfigs(int paramInt, ArrayList<PhysicalChannelConfig> paramArrayList)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
      localHwParcel.writeInt32(paramInt);
      PhysicalChannelConfig.writeVectorToParcel(localHwParcel, paramArrayList);
      paramArrayList = new HwParcel();
      try
      {
        mRemote.transact(52, localHwParcel, paramArrayList, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
    ...
    public void currentSignalStrength_1_2(int paramInt, SignalStrength paramSignalStrength)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
      ...
      try
      {
        mRemote.transact(53, localHwParcel, paramSignalStrength, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
    ...
    public void networkScanResult_1_2(int paramInt, NetworkScanResult paramNetworkScanResult)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
      ...
      try
      {
        mRemote.transact(49, localHwParcel, paramNetworkScanResult, 1);
        localHwParcel.releaseTemporaryStorage();
        return;
      }
      finally
    ...
    implements IRadioIndication
  {
    ...
    {
      return new ArrayList(Arrays.asList(new byte[][] { { -51, -89, 82, -82, -85, -86, -68, 32, 72, 106, -126, -84, 87, -93, -35, 16, 119, -123, -64, 6, 9, 74, 52, -101, -59, -30, 36, -24, -86, 34, -95, 124 }, { -4, -59, -56, -56, -117, -123, -87, -10, 63, -70, 103, -39, -26, 116, -38, 70, 108, 114, -87, -116, -94, -121, -13, 67, -5, 87, 33, -48, -104, 113, 63, -122 }, { 92, -114, -5, -71, -60, 81, -91, -105, 55, -19, 44, 108, 32, 35, 10, -82, 71, 69, -125, -100, -96, 29, -128, -120, -42, -36, -55, 2, 14, 82, -46, -59 }, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
      ...
      throws RemoteException
    {
      ...
      case 53: 
        ...
        {
          paramHwParcel1.enforceInterface("android.hardware.radio@1.2::IRadioIndication");
          paramInt1 = paramHwParcel1.readInt32();
          paramHwParcel2 = new SignalStrength();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          currentSignalStrength_1_2(paramInt1, paramHwParcel2);
        }
        break;
      case 52: 
        paramInt1 = i1;
        ...
        {
          paramHwParcel1.enforceInterface("android.hardware.radio@1.2::IRadioIndication");
          currentPhysicalChannelConfigs(paramHwParcel1.readInt32(), PhysicalChannelConfig.readVectorFromParcel(paramHwParcel1));
        }
        break;
      case 51: 
        paramInt1 = i2;
        ...
        else
        {
          paramHwParcel1.enforceInterface("android.hardware.radio@1.2::IRadioIndication");
          paramInt1 = paramHwParcel1.readInt32();
          paramHwParcel2 = new LinkCapacityEstimate();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          currentLinkCapacityEstimate(paramInt1, paramHwParcel2);
        }
        break;
      case 50: 
        paramInt1 = i3;
        ...
        {
          paramHwParcel1.enforceInterface("android.hardware.radio@1.2::IRadioIndication");
          cellInfoList_1_2(paramHwParcel1.readInt32(), CellInfo.readVectorFromParcel(paramHwParcel1));
        }
        break;
      case 49: 
        paramInt1 = i4;
        ...
        else
        {
          ...
          paramHwParcel2.readFromParcel(paramHwParcel1);
          networkScanResult_1_2(paramInt1, paramHwParcel2);
        }
        break;
      case 48: 
        paramInt1 = i5;
      ...
      case 47: 
        ...
        else
        {
          paramHwParcel1.enforceInterface("android.hardware.radio@1.1::IRadioIndication");
          paramInt1 = paramHwParcel1.readInt32();
          paramHwParcel2 = new android.hardware.radio.V1_1.NetworkScanResult();
          paramHwParcel2.readFromParcel(paramHwParcel1);
      ...
      case 35: 
        ...
        {
          paramHwParcel1.enforceInterface("android.hardware.radio@1.0::IRadioIndication");
          cellInfoList(paramHwParcel1.readInt32(), android.hardware.radio.V1_0.CellInfo.readVectorFromParcel(paramHwParcel1));
        }
        break;
      case 34: 
        paramInt1 = i19;
    ...
    {
      if ("android.hardware.radio@1.2::IRadioIndication".equals(paramString)) {
        return this;
      }
      return null;
    }
