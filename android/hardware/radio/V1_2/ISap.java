  ...
  extends android.hardware.radio.V1_1.ISap
{
  ...
  public static ISap asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.2::ISap");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)((Iterator)localObject).next()).equals("android.hardware.radio@1.2::ISap");
        if (bool) {
  ...
  public static ISap getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.2::ISap", paramString));
  }
  
  public static ISap getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.2::ISap", paramString, paramBoolean));
  }
    ...
    implements ISap
  {
    ...
    {
      byte[] arrayOfByte1 = { 45, -122, -110, -105, -108, 121, 94, 92, 112, -12, -3, -75, 7, 52, -123, -3, 5, -125, 92, -100, 111, 73, 97, 22, 104, 124, 61, -97, 50, -26, -33, 62 };
      byte[] arrayOfByte2 = { -34, 58, -71, -9, 59, 16, 115, -51, 103, 123, 25, -40, -122, -5, -110, 126, -109, -127, -77, 1, 97, -89, 4, 113, 45, 43, 48, -8, 117, -121, 63, 92 };
      return new ArrayList(Arrays.asList(new byte[][] { arrayOfByte1, { -7, 108, -68, 89, -33, -31, 108, -115, 12, 42, 126, 6, -37, 36, -40, 115, -118, 99, 40, -74, -23, 15, 123, -114, 22, 64, -22, 43, 70, 0, -34, -67 }, arrayOfByte2, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
    
    public final ArrayList<String> interfaceChain()
    {
      return new ArrayList(Arrays.asList(new String[] { "android.hardware.radio@1.2::ISap", "android.hardware.radio@1.1::ISap", "android.hardware.radio@1.0::ISap", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor()
    {
      return "android.hardware.radio@1.2::ISap";
    }
    ...
    {
      if ("android.hardware.radio@1.2::ISap".equals(paramString)) {
        return this;
      }
      return null;
    }
