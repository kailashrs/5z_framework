...
public final class CellInfoGsm
{
  ...
  public static final ArrayList<CellInfoGsm> readVectorFromParcel(HwParcel paramHwParcel)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      localCellInfoGsm.readEmbeddedFromParcel(paramHwParcel, localHwBlob, j * 96);
  ...
  public static final void writeVectorToParcel(HwParcel paramHwParcel, ArrayList<CellInfoGsm> paramArrayList)
  {
    ...
    while (j < i)
    {
      ((CellInfoGsm)paramArrayList.get(j)).writeEmbeddedToBlob(localHwBlob2, j * 96);
      j++;
    }
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong)
  {
    ...
    signalStrengthGsm.readEmbeddedFromParcel(paramHwParcel, paramHwBlob, 80L + paramLong);
  }
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong)
  {
    ...
    signalStrengthGsm.writeEmbeddedToBlob(paramHwBlob, 80L + paramLong);
  }
