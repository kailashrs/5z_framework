...
public final class CellIdentity
{
  ...
  public static final ArrayList<CellIdentity> readVectorFromParcel(HwParcel paramHwParcel)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      CellIdentity localCellIdentity = new CellIdentity();
      localCellIdentity.readEmbeddedFromParcel(paramHwParcel, localHwBlob, j * 88);
      localArrayList.add(localCellIdentity);
    }
  ...
  public final void readEmbeddedFromParcel(HwParcel paramHwParcel, HwBlob paramHwBlob, long paramLong)
  {
    ...
    Object localObject1 = paramHwParcel.readEmbeddedBuffer(i * 80, paramHwBlob.handle(), paramLong + 8L + 0L, true);
    cellIdentityGsm.clear();
    int j = 0;
    for (int k = 0; k < i; k++)
    {
      localObject2 = new CellIdentityGsm();
      ((CellIdentityGsm)localObject2).readEmbeddedFromParcel(paramHwParcel, (HwBlob)localObject1, k * 80);
      cellIdentityGsm.add(localObject2);
    }
    i = paramHwBlob.getInt32(paramLong + 24L + 8L);
    localObject1 = paramHwParcel.readEmbeddedBuffer(i * 80, paramHwBlob.handle(), paramLong + 24L + 0L, true);
    cellIdentityWcdma.clear();
    for (k = 0; k < i; k++)
    {
      localObject2 = new CellIdentityWcdma();
      ((CellIdentityWcdma)localObject2).readEmbeddedFromParcel(paramHwParcel, (HwBlob)localObject1, k * 80);
      cellIdentityWcdma.add(localObject2);
    }
    i = paramHwBlob.getInt32(paramLong + 40L + 8L);
    localObject1 = paramHwParcel.readEmbeddedBuffer(i * 56, paramHwBlob.handle(), paramLong + 40L + 0L, true);
    cellIdentityCdma.clear();
    for (k = 0; k < i; k++)
    {
      localObject2 = new CellIdentityCdma();
      ((CellIdentityCdma)localObject2).readEmbeddedFromParcel(paramHwParcel, (HwBlob)localObject1, k * 56);
      cellIdentityCdma.add(localObject2);
    }
    i = paramHwBlob.getInt32(paramLong + 56L + 8L);
    Object localObject2 = paramHwParcel.readEmbeddedBuffer(i * 88, paramHwBlob.handle(), paramLong + 56L + 0L, true);
    cellIdentityLte.clear();
    for (k = 0; k < i; k++)
    {
      localObject1 = new CellIdentityLte();
      ((CellIdentityLte)localObject1).readEmbeddedFromParcel(paramHwParcel, (HwBlob)localObject2, k * 88);
      cellIdentityLte.add(localObject1);
    }
    i = paramHwBlob.getInt32(paramLong + 72L + 8L);
    localObject2 = paramHwParcel.readEmbeddedBuffer(i * 88, paramHwBlob.handle(), 0L + (paramLong + 72L), true);
    cellIdentityTdscdma.clear();
    for (k = j; k < i; k++)
    {
      paramHwBlob = new CellIdentityTdscdma();
      paramHwBlob.readEmbeddedFromParcel(paramHwParcel, (HwBlob)localObject2, k * 88);
  ...
  public final void writeEmbeddedToBlob(HwBlob paramHwBlob, long paramLong)
  {
    ...
    HwBlob localHwBlob = new HwBlob(i * 80);
    for (int k = 0; k < i; k++) {
      ((CellIdentityGsm)cellIdentityGsm.get(k)).writeEmbeddedToBlob(localHwBlob, k * 80);
    }
    ...
    for (k = 0; k < i; k++) {
      ((CellIdentityWcdma)cellIdentityWcdma.get(k)).writeEmbeddedToBlob(localHwBlob, k * 80);
    }
    ...
    for (k = 0; k < i; k++) {
      ((CellIdentityCdma)cellIdentityCdma.get(k)).writeEmbeddedToBlob(localHwBlob, k * 56);
    }
    ...
    localHwBlob = new HwBlob(i * 88);
    for (k = 0; k < i; k++) {
      ((CellIdentityLte)cellIdentityLte.get(k)).writeEmbeddedToBlob(localHwBlob, k * 88);
    }
    ...
    localHwBlob = new HwBlob(i * 88);
    for (k = j; k < i; k++) {
      ((CellIdentityTdscdma)cellIdentityTdscdma.get(k)).writeEmbeddedToBlob(localHwBlob, k * 88);
    }
