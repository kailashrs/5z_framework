...
public abstract interface IRadioResponse
  extends android.hardware.radio.V1_0.IRadioResponse
{
  ...
  public static IRadioResponse asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.1::IRadioResponse");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)((Iterator)localObject).next()).equals("android.hardware.radio@1.1::IRadioResponse");
        if (bool) {
  ...
  public abstract void setCarrierInfoForImsiEncryptionResponse(RadioResponseInfo paramRadioResponseInfo)
    throws RemoteException;
  
  public abstract void setHALInstrumentation()
    throws RemoteException;
  
  public abstract void setSimCardPowerResponse_1_1(RadioResponseInfo paramRadioResponseInfo)
    throws RemoteException;
  
  public abstract void startKeepaliveResponse(RadioResponseInfo paramRadioResponseInfo, KeepaliveStatus paramKeepaliveStatus)
    throws RemoteException;
  
  public abstract void startNetworkScanResponse(RadioResponseInfo paramRadioResponseInfo)
    throws RemoteException;
  
  public abstract void stopKeepaliveResponse(RadioResponseInfo paramRadioResponseInfo)
    throws RemoteException;
  
  public abstract void stopNetworkScanResponse(RadioResponseInfo paramRadioResponseInfo)
    throws RemoteException;
    ...
    implements IRadioResponse
  {
    ...
    {
      return new ArrayList(Arrays.asList(new byte[][] { { 5, -86, 61, -26, 19, 10, -105, -120, -3, -74, -12, -45, -52, 87, -61, -22, -112, -16, 103, -25, 122, 94, 9, -42, -89, 114, -20, 127, 107, -54, 51, -46 }, { 45, -125, 58, -18, -48, -51, 29, 89, 67, 122, -54, 33, 11, -27, -112, -87, 83, -49, 50, -68, -74, 104, 60, -42, 61, 8, -105, 98, -90, 67, -5, 73 }, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
      ...
      throws RemoteException
    {
        ...
        case 256398152: 
          ...
          else
          {
            ...
            for (paramInt1 = m; paramInt1 < paramInt2; paramInt1++) {
              ((HwBlob)localObject).putInt8Array(paramInt1 * 32, (byte[])paramHwParcel1.get(paramInt1));
            }
            localHwBlob.putBlob(0L, (HwBlob)localObject);
      ...
      case 123: 
        ...
        else
        {
          ...
          localObject = new RadioResponseInfo();
          ((RadioResponseInfo)localObject).readFromParcel(paramHwParcel1);
          paramHwParcel2 = new ActivityStatsInfo();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          getModemActivityInfoResponse((RadioResponseInfo)localObject, paramHwParcel2);
        }
        break;
      case 122: 
        paramInt1 = i13;
      ...
      case 107: 
        ...
        else
        {
          ...
          localObject = new IccIoResult();
          ((IccIoResult)localObject).readFromParcel(paramHwParcel1);
          iccTransmitApduLogicalChannelResponse(paramHwParcel2, (IccIoResult)localObject);
        }
        break;
      case 106: 
        paramInt1 = i29;
      ...
      case 103: 
        ...
        else
        {
          ...
          paramHwParcel2.readFromParcel(paramHwParcel1);
          sendImsSmsResponse((RadioResponseInfo)localObject, paramHwParcel2);
        }
        break;
      case 102: 
        paramInt1 = i33;
      ...
      case 27: 
        ...
        else
        {
          ...
          localObject = new RadioResponseInfo();
          ((RadioResponseInfo)localObject).readFromParcel(paramHwParcel1);
          paramHwParcel2 = new SetupDataCallResult();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          setupDataCallResponse((RadioResponseInfo)localObject, paramHwParcel2);
        }
        break;
      case 26: 
        paramInt1 = i109;
        ...
        else
        {
          ...
          paramHwParcel2 = new SendSmsResult();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          sendSMSExpectMoreResponse((RadioResponseInfo)localObject, paramHwParcel2);
        }
        break;
      case 25: 
        paramInt1 = i110;
      ...
      case 20: 
        ...
        else
        {
          ...
          ((VoiceRegStateResult)localObject).readFromParcel(paramHwParcel1);
          getVoiceRegistrationStateResponse(paramHwParcel2, (VoiceRegStateResult)localObject);
        }
        break;
      case 19: 
        paramInt1 = i116;
      ...
      case 18: 
        ...
        else
        {
          ...
          localObject = new RadioResponseInfo();
          ((RadioResponseInfo)localObject).readFromParcel(paramHwParcel1);
          paramHwParcel2 = new LastCallFailCauseInfo();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          getLastCallFailCauseResponse((RadioResponseInfo)localObject, paramHwParcel2);
        }
        break;
      case 17: 
        paramInt1 = i118;
    ...
    {
      if ("android.hardware.radio@1.1::IRadioResponse".equals(paramString)) {
        return this;
      }
      return null;
    }
