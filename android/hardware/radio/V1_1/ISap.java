...
public abstract interface ISap
  extends android.hardware.radio.V1_0.ISap
{
  ...
  public static ISap asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.1::ISap");
    ...
    try
    {
      paramIHwBinder = ((ISap)localObject).interfaceChain().iterator();
      while (paramIHwBinder.hasNext())
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.radio@1.1::ISap");
        if (bool) {
          return localObject;
        }
      }
  ...
  public static ISap getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.1::ISap", paramString));
  }
  
  public static ISap getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.1::ISap", paramString, paramBoolean));
  }
    ...
    implements ISap
  {
    ...
    {
      return new ArrayList(Arrays.asList(new byte[][] { { -7, 108, -68, 89, -33, -31, 108, -115, 12, 42, 126, 6, -37, 36, -40, 115, -118, 99, 40, -74, -23, 15, 123, -114, 22, 64, -22, 43, 70, 0, -34, -67 }, { -34, 58, -71, -9, 59, 16, 115, -51, 103, 123, 25, -40, -122, -5, -110, 126, -109, -127, -77, 1, 97, -89, 4, 113, 45, 43, 48, -8, 117, -121, 63, 92 }, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
    
    public final ArrayList<String> interfaceChain()
    {
      return new ArrayList(Arrays.asList(new String[] { "android.hardware.radio@1.1::ISap", "android.hardware.radio@1.0::ISap", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor()
    {
      return "android.hardware.radio@1.1::ISap";
    }
    ...
    {
      if ("android.hardware.radio@1.1::ISap".equals(paramString)) {
        return this;
      }
      return null;
    }
