  ...
  extends android.hardware.radio.V1_0.IRadio
{
  ...
  public static IRadio asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio@1.1::IRadio");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.radio@1.1::IRadio");
        if (bool) {
          return localObject;
        }
      }
  ...
  public static IRadio getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.1::IRadio", paramString));
  }
  
  public static IRadio getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio@1.1::IRadio", paramString, paramBoolean));
  }
  ...
  public abstract void setCarrierInfoForImsiEncryption(int paramInt, ImsiEncryptionInfo paramImsiEncryptionInfo)
    throws RemoteException;
  
  public abstract void setHALInstrumentation()
    throws RemoteException;
  
  public abstract void setSimCardPower_1_1(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void startKeepalive(int paramInt, KeepaliveRequest paramKeepaliveRequest)
    throws RemoteException;
  
  public abstract void startNetworkScan(int paramInt, NetworkScanRequest paramNetworkScanRequest)
    throws RemoteException;
  
  public abstract void stopKeepalive(int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract void stopNetworkScan(int paramInt)
    throws RemoteException;
    ...
    implements IRadio
  {
    ...
    public void startNetworkScan(int paramInt, NetworkScanRequest paramNetworkScanRequest)
      throws RemoteException
    {
      HwParcel localHwParcel = new HwParcel();
      localHwParcel.writeInterfaceToken("android.hardware.radio@1.1::IRadio");
    ...
    implements IRadio
  {
    ...
    {
      return new ArrayList(Arrays.asList(new byte[][] { { -9, -98, -33, 80, -93, 120, -87, -55, -69, 115, 127, -109, -14, 5, -38, -71, 27, 76, 99, -22, 73, 114, 58, -4, 111, -123, 108, 19, -126, 3, -22, -127 }, { -101, 90, -92, -103, -20, 59, 66, 38, -15, 95, 72, -11, -19, 8, -119, 110, 47, -64, 103, 111, -105, -116, -98, 25, -100, 29, -94, 29, -86, -16, 2, -90 }, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
      ...
      throws RemoteException
    {
      ...
      case 28: 
        ...
        else
        {
          ...
          paramHwParcel2 = new DataProfileInfo();
          paramHwParcel2.readFromParcel(paramHwParcel1);
          setupDataCall(paramInt1, paramInt2, paramHwParcel2, paramHwParcel1.readBool(), paramHwParcel1.readBool(), paramHwParcel1.readBool());
        }
        break;
      case 27: 
        paramInt1 = i109;
    ...
    {
      if ("android.hardware.radio@1.1::IRadio".equals(paramString)) {
        return this;
      }
      return null;
    }
