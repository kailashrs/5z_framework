  ...
  extends IBase
{
  ...
  public static IOemHookResponse asInterface(IHwBinder paramIHwBinder)
  {
    ...
    try
    {
      paramIHwBinder = ((IOemHookResponse)localObject).interfaceChain().iterator();
      while (paramIHwBinder.hasNext())
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.radio.deprecated@1.0::IOemHookResponse");
        if (bool) {
          return localObject;
        }
      }
    ...
    implements IOemHookResponse
  {
    ...
    public final ArrayList<byte[]> getHashChain()
    {
      ...
      return new ArrayList(Arrays.asList(new byte[][] { { 111, -44, -121, 79, 14, -35, -44, 98, 106, 39, 101, -113, -39, 79, -83, 82, 108, 49, 127, 53, 99, 67, -98, 121, 113, -117, -37, 26, 58, 35, 9, -43 }, arrayOfByte }));
    }
