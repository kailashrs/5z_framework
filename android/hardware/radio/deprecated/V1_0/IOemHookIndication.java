  ...
  extends IBase
{
  ...
  public static IOemHookIndication asInterface(IHwBinder paramIHwBinder)
  {
    ...
    try
    {
      paramIHwBinder = ((IOemHookIndication)localObject).interfaceChain().iterator();
      while (paramIHwBinder.hasNext())
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.radio.deprecated@1.0::IOemHookIndication");
        if (bool) {
          return localObject;
        }
      }
    ...
    implements IOemHookIndication
  {
    ...
    {
      return new ArrayList(Arrays.asList(new byte[][] { { 6, -125, 123, 109, 126, -124, 60, -6, -100, -46, 15, -19, 64, 112, -2, -54, 122, -101, 92, -127, -87, -19, 100, 59, -9, -48, 104, 3, 69, 90, -104, 22 }, { -67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39 } }));
    }
