...
public class EGL14
{
  ...
  private static native EGLSurface _eglCreateWindowSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt, int paramInt);
  
  private static native EGLSurface _eglCreateWindowSurfaceTexture(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt, int paramInt);
  ...
  public static native EGLSurface eglCreatePbufferFromClientBuffer(EGLDisplay paramEGLDisplay, int paramInt1, long paramLong, EGLConfig paramEGLConfig, int[] paramArrayOfInt, int paramInt2);
  ...
  public static EGLSurface eglCreateWindowSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt, int paramInt)
  {
    ...
    for (paramEGLDisplay = _eglCreateWindowSurface(paramEGLDisplay, paramEGLConfig, localSurface, paramArrayOfInt, paramInt);; paramEGLDisplay = _eglCreateWindowSurfaceTexture(paramEGLDisplay, paramEGLConfig, paramObject, paramArrayOfInt, paramInt))
    {
      break;
  ...
  public static native EGLDisplay eglGetDisplay(long paramLong);
