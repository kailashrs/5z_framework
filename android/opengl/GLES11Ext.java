...
public class GLES11Ext
{
  ...
  public static void glMatrixIndexPointerOES(int paramInt1, int paramInt2, int paramInt3, Buffer paramBuffer)
  {
  ...
  private static native void glMatrixIndexPointerOESBounds(int paramInt1, int paramInt2, int paramInt3, Buffer paramBuffer, int paramInt4);
  ...
  public static void glWeightPointerOES(int paramInt1, int paramInt2, int paramInt3, Buffer paramBuffer)
  {
    glWeightPointerOESBounds(paramInt1, paramInt2, paramInt3, paramBuffer, paramBuffer.remaining());
  }
  
  private static native void glWeightPointerOESBounds(int paramInt1, int paramInt2, int paramInt3, Buffer paramBuffer, int paramInt4);
}
