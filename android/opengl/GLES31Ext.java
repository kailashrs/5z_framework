...
public class GLES31Ext
{
  ...
  public static abstract interface DebugProcKHR
  {
    public abstract void onMessage(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString);
  }
}
